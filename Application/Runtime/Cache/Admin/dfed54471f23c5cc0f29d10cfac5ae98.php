...
<div class="main-div">
    <form method="post" action="/merlin/index.php/Admin/Category/edit/cat_id/16.html"enctype="multipart/form-data" >
            ...
            <tr>
                ...
                <td>
                    <select name="parent_id">
                        ...
                        <?php if(is_array($cats)): foreach($cats as $key=>$v): ?><option value="<?php echo ($v['cat_id']); ?>" <?php if($data['parent_id'] == $v['cat_id']): ?>selected=selected<?php endif; ?> >
                                <?php echo str_repeat('-',4*$v['level']);; echo ($v['cat_name']); ?>
