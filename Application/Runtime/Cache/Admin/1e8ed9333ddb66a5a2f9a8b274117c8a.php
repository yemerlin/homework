...
<div class="main-div">
    <form method="post" action="/merlin/index.php/Admin/MemberLevel/edit/level_id/2.html"enctype="multipart/form-data" >
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                <td class="label">等级名称</td>
                <td>
                    <input type="text" name="level_name" maxlength="60" value="<?php echo ($data['level_name']); ?>" />
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="jifen_bottom" maxlength="60" size="40" value="<?php echo ($data['jifen_bottom']); ?>" />
                </td>
            </tr>
            <tr>
                <td class="label">积分上限</td>
                <td>
                    <input type="text" name="jifen_top" maxlength="60" size="40" value="<?php echo ($data['jifen_top']); ?>" />
                </td>
            </tr>
            <tr>
